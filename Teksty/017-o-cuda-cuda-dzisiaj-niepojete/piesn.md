---
numer: 17
tytul: "O cuda cuda dzisiaj niepojęte"
...
## [V1] Zwrotka 1
O cuda cuda dzisiaj niepojęte `e a D B`
Cóż Ci się, Jezu, spodobało we mnie
Żeś z tronu chwały zszedł
W mej duszy ciernie

## [C] Refren
Jezus jest we mnie w moim sercu żyje `e a D G`
On jest mój, a ja Jego wyłącznie jedynie `e a D B`
